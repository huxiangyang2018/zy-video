  ...
  <body>  
	...
	<form class="form-horizontal" action="${pageContext.request.contextPath }/speaker/addSpeaker.action" method="post">
  		<div class="form-group">
    		...
    		<div class="col-md-7">
      			<input type="text" class="form-control" name="speakerName" id="inputEmail3" placeholder="主讲人姓名">
    		</div>
  		</div>
		...
		<div class="form-group">
    		...
    		<div class="col-md-7">
      			<input type="text" class="form-control" name="speakerJob" id="inputEmail3" placeholder="主讲人职业">
    		</div>
  		</div>
		...
		<div class="form-group">
    		...
    		<div class="col-md-7">
      			<input type="text" class="form-control" name="speakerHeadUrl" id="inputEmail3" placeholder="主讲人头像图片">
    		</div>
  		</div>
		...
		<div class="form-group">
    		...
    		<div class="col-md-7">
      			<textarea class="form-control" name="speakerDescr" rows="3"></textarea>
    		</div>
  		</div>
  		<div class="actions">
